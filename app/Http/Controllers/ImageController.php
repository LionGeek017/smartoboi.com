...
//        dd($imgJson);
        ...
        if($imgJson) {
            $imgUrl = $imgJson->src->original;
            $get_headers = get_headers($imgUrl, 1);
            $img_size_mb = $get_headers["Content-Length"] / 1024 / 1024;
...
//        if ($imageSize['mime'] == 'image/jpeg' || $imageSize['mime'] == 'image/jpg' || $imageSize['mime'] == 'image/JPEG' || $imageSize['mime'] == 'image/JPG') {
//            $imageOriginal_ = imagecreatefromjpeg($imageOriginal);
//            unlink($imageOriginal);
//
//            imagejpeg($imageOriginal_, $originalPath . '/' . $imageName, 90);
//        } elseif ($imageSize['mime'] == 'image/png') {
//            $imageOriginal_ = imagecreatefrompng($imageOriginal);
//            unlink($imageOriginal);
//
//            imagepng($imageOriginal_, $originalPath . '/' . $imageName, 5);
//        }
